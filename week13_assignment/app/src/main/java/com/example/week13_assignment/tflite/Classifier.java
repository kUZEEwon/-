package com.example.week13_assignment.tflite;
...
public class Classifier {
    ...
    Context context;
    Interpreter interpreter = null;    //인터프리터 선언
    ...
    //ByteBuffer선언 및 Interpreter선언을 통한 TFLite Model 로드
    ...
    private ByteBuffer loadModelFile(String modelName) throws IOException{
        ...
        FileInputStream fis = new FileInputStream(afd.getFileDescriptor()); //MappedByteBuffer 자료형으로 읽기
    ...
    public Pair<Integer, Float> classify(Bitmap image) {
        ...
        interpreter.run(buffer, result); //interpreter의 run함수활용한 TFLite Model분류
        //최대값 추출
